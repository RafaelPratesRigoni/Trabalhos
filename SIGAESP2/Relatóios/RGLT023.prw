...
While TRB->(!Eof())
	...
	If cUltTicket != TRB->ZLC_TICKET
		...
		@nLin,000 PSAY "Ticket:" + TRB->ZLC_TICKET + "   Data : " + DtoC(StoD(TRB->ZLC_DTCOLE)) + "  Hora Recep็ใo : " + TRB->ZLC_HORDES
		nLin += 1
...
@nLin,070 PSAY "Diferen็a de volume:"+TransForm(nTotCol-nTotVol,"@E 999,999,999")
//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
...
@nLin,070 PSAY "Diferen็a de volume:"+TransForm(nSubCol-nSubVol,"@E 999,999,999")
