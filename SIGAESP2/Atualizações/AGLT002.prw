...
ฑฑบPrograma  ณ AGLT002  บ Autor ณ TOTVS                 บ Data da Criacao  ณ 12/11/2008                						บฑฑ
...
oBrowse:SetDescripton("Cadastro de Veํculos") 
...
Static Function ModelDef()
	...
	oModel:SetDescription('Cadastro de Veํculos')
	oModel:GetModel( 'ID_MODEL_FLD_ZL4' ):SetDescription( 'Cadastro de Veํculos' )
...
Static Function ViewDef()
	...
	oStruct1:SetProperty( 'ZL4_CAPACI' , MVC_VIEW_CANCHANGE, .F. )
	...
	oView:SetFieldAction( 'ZL4_BOCA1', { |oView, cIDView, cField, xValue| SomaTot( oView, cIDView, cField, xValue ) } )
	oView:SetFieldAction( 'ZL4_BOCA2', { |oView, cIDView, cField, xValue| SomaTot( oView, cIDView, cField, xValue ) } )
	oView:SetFieldAction( 'ZL4_BOCA3', { |oView, cIDView, cField, xValue| SomaTot( oView, cIDView, cField, xValue ) } )
	oView:SetFieldAction( 'ZL4_BOCA4', { |oView, cIDView, cField, xValue| SomaTot( oView, cIDView, cField, xValue ) } )
...
//********************************************************
Static Function SomaTot( oView, cIDView, cField, xValue,nLinha )


Local lRet 			:= .T.
Local oModel 		:= FWModelActive()
Local oStruct		:= oModel:GetModel( 'ID_MODEL_FLD_ZL4' ) 
Local nOperation	:= oModel:GetOperation()
Local _nQtd := 0

If nOperation <> MODEL_OPERATION_DELETE	//.and. oGridZNB:Length() == 1 	.and. Empty(oGridZNB:GetValue('ZNB_MES'))

	_nQtd += oStruct:GetValue("ZL4_BOCA1")		
	_nQtd += oStruct:GetValue("ZL4_BOCA2")		
	_nQtd += oStruct:GetValue("ZL4_BOCA3")		
	_nQtd += oStruct:GetValue("ZL4_BOCA4")		
	oStruct:LoadValue("ZL4_CAPACI",_nQtd)		
EndIf   
...
If ((U_chkZLD("ZLD_VEICUL",ZL4->ZL4_COD))  .and. (U_chkZLW("ZLW_VEICUL",ZL4->ZL4_COD)) )
	...
	lOk := ( FWExecView('Valida็ใo de Exclusใo','AGLT002', MODEL_OPERATION_DELETE,, ,  ) == 0 )
