...
/*/{Protheus.doc} FISRY018
Relatório (Mapa Produção Ovo Trincado / Ovo Líquido) Fechamento Mensal = Regime Especial SEFAZ 
@type function
@version  
@author Rafael.Rigoni
@since 25/11/2022
/*/
User Function FISRY018()
...
Static Function ReportDef()
	...
	IF MV_PAR04 = 1
        ...
        TrCell():New(oSection3,"NOME"           ,,"NOME PRODUTOR RURAL","@!",40)
        Trcell():New(oSection3,"INSCRICAO"      ,,"INSCRIÇÃO "         ,    ,15)
